...
var TodayComponent = (function () {
    function TodayComponent(_route, _appointmentService) {
        this._route = _route;
    ...
    TodayComponent.prototype.ngOnInit = function () {
        ...
        this._route.params
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setQuery(params['query'])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TodayComponent.prototype.setQuery = function (query) {
    ...
    TodayComponent.prototype.search = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this._appointmentService.SearchAppointments(this.query)];
                    case 1:
                        _a.results = _b.sent();
                        return [2 /*return*/];
                }
